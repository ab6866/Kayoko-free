...
- (instancetype)initWithTitle:(NSString *)title {
    ...
    if (self) {
        ...
        // The capsule is a pure read-out: it is welded to the title's trailing
        // edge and vertically centred on it, so the pair reads as one unit at any
        // font size. It deliberately owns no interaction -- attaching a menu
        // here made a long press open the list and could deliver an extra
        // touch-up after dismissal.
